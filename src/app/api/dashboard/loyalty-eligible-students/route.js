...
export async function GET() {
  ...
  try {
    const laravelResponse = await fetch(`${process.env.LARAVEL_API_URL}/api/dashboard/loyalty-eligible-students`, {
      method: "GET",
      headers: {
    ...
    console.error("Loyalty eligible students fetch error:", error);
