...
export async function GET(request) {
  ...
  try {
    const laravelResponse = await fetch(`${process.env.LARAVEL_API_URL}/api/teachers${search}`, {
      method: "GET",
      headers: {
    ...
    console.error("Teachers list fetch error:", error);
...
export async function POST(request) {
  ...
  try {
    const laravelResponse = await fetch(`${process.env.LARAVEL_API_URL}/api/teachers`, {
      method: "POST",
      headers: {
