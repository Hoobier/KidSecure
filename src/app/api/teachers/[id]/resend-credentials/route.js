...
// src/app/api/teachers/[id]/resend-credentials/route.js
...
export async function POST(request, { params }) {
  ...
  try {
    const laravelResponse = await fetch(
      `${process.env.LARAVEL_API_URL}/api/teachers/${id}/resend-credentials`,
      {
        method: "POST",
        headers: {
    ...
    console.error("Teacher resend-credentials error:", error);
