...
// src/app/api/enrollment/rfid/pending-scan/route.js
...
export async function GET() {
  ...
  try {
    const laravelResponse = await fetch(
      `${process.env.LARAVEL_API_URL}/api/enrollment/rfid/pending-scan`,
      {
        method: "GET",
        headers: {
    ...
    console.error("RFID pending-scan error:", error);
