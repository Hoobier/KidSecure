...
// src/app/api/teacher/students/[id]/report-card/submit/route.js
...
export async function POST(request, { params }) {
  ...
  try {
    const laravelResponse = await fetch(
      `${process.env.LARAVEL_API_URL}/api/teacher/students/${id}/report-card/submit`,
      {
        method: "POST",
        headers: {
    ...
    console.error("Teacher submitReportCard proxy error:", error);
