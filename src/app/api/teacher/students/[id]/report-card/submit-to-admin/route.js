...
// src/app/api/teacher/students/[id]/report-card/submit-to-admin/route.js
...
export async function POST(request, { params }) {
  ...
  try {
    const laravelResponse = await fetch(
      `${process.env.LARAVEL_API_URL}/api/teacher/students/${id}/report-card/submit-to-admin`,
      {
        method: "POST",
        headers: {
    ...
    console.error("Teacher submitToAdmin proxy error:", error);
