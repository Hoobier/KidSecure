...
export default function TeacherDashboardPage() {
  ...
  return <div className="teacher-dashboard">
    ...
    {Object.prototype.hasOwnProperty.call(summary, "teachingLoad") && <section className="teacher-load-panel"><h2>My Teaching Load</h2><p><strong>{summary.teachingLoad.forteSubjectCode || "Not assigned"}</strong> · Forte subject</p><p>Visiting grades: {(summary.teachingLoad.visitingGrades || []).join(", ") || "None"}</p></section>}
  </div>;
}